...
const MarketInfoModalContent: React.FC<{}> = () => {
    ...
    return (
        ...
        <span>Produção:</span>
            <table>
                ...
                <tr>
                    <td>{selected_city?.production?.gold}</td>
                    <td>{(selected_city?.production?.gold ?? 0) * 24}</td>
                    <td>{selected_city?.storage?.current?.gold}</td>
                    <td>{selected_city?.storage?.full_at?.gold}</td>
...
export default MarketInfoModalContent;